...
import { signup, prodSignup, type SignupState, type ProdSignupState } from "@/lib/server/account";
import { Card, SectionLabel, Input, Button } from "@/components/ui";

const IS_PROD = process.env.NEXT_PUBLIC_APP_MODE === "prod";

function ProdSignup() {
  const [state, formAction, pending] = useActionState<ProdSignupState, FormData>(prodSignup, {});
  return (
    <Card className="p-8">
